...
let
  sources = {
    ...
    "puppeteer-core-2.1.0" = {
      ...
      version = "2.1.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/puppeteer-core/-/puppeteer-core-2.1.0.tgz";
        sha512 = "RaW+dwL9A/039DTkolg3qTIsy0AnGBCH7KltlQBQoMqBIiEsr8rTh81uYhjGTsdoDKqIDgmk2PldOrUOMQ4EcQ==";
      };
    };
